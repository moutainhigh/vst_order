...
<div class="pages darkstyle">	
    ...
    <form action="${pageInfo.url}"  id="paginationForm" name="pagination">
    ...
    <p class="pages_go">到第 <input type="text" class="w1" name="pageNum" number=true totalPage="${pageInfo.totalPageNum}"> 页 <button type="button"  class="btn btn-mini pagination">确定</button></p>
    <div class="Pages">
