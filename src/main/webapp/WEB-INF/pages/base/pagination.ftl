    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		$("div.pages a[page],div.pages button.pagination").click(function(){
    		    //防止重复点击页码，导致增加系统负载
    			if(typeof checkReSubmitFlag != 'undefined' && checkReSubmitFlag != null && checkReSubmitFlag && isSubmitted) {
    				return false;
    			}
    			var $this = $(this);
    			...
    			//防止重复点击页码，导致增加系统负载
    			if(typeof checkReSubmitFlag != 'undefined' && checkReSubmitFlag != null && checkReSubmitFlag) {
	    			isSubmitted = true;
