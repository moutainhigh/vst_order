		...
		<div class="p_box mt20">
			<div class="hotel_wrap">
	            ...
	            <div class="hotel_tab">
                    ...
                    <span class="orderUntile">至</span>
                    <input id="endVisitTimeInput" type="text"  data-check="checkOut" autocomplete="off" readonly value="${endDate?string('yyyy-MM-dd')!''}" name="itemMap[${suppGoods.suppGoodsId}].wifiAdditation.backTime" data-range="true" class="J_calendar js_youwanTime cal_style" placeholder="请选择结束日期" required>
	            </div>
	        </div>
		</div>
		<div class="p_box mt20">
            ...
            <div id="ticketDiv" class="hotel_tab">
             ...
             <#elseif suppGoods.goodsType =="NOTICETYPE_DISPLAY" >
             <#include "/order/wifi/inc/pickup_wifi.ftl"/>
             </#if>
