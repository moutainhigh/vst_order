<form id="addAmountChangeForm">
    ...
    <table class="e_table form-inline " id="table">
        ...
        <tr>
            ...
            <td class="w6">
                <input type="text" class="w160" id="newTotalPrice" name="newTotalPrice"
                       value="${ordOrderItemExtend.foreignActTotalSettlePrice/100.0}"
                       oldData="${ordOrderItemExtend.foreignActTotalSettlePrice/100.0}" maxlength="10" isAmountNum="true"/>
...
<script>
    $("#submitAddAmountChangeForm").bind("click", function () {
        ...
        var totalSettlementPrice = $("#newTotalPrice").val();
        ...
        $.ajax({
            url: '/vst_order/order/orderSettlementChange/addCurrencyTotalSettlementChange.do',
