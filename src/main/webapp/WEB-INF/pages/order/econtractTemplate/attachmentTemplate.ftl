<p>
          ...
          <tr>
            ...
            <tr>
            	<td colspan="8" style="text-align:left;">
                    ...
                    <span ></span>
                    <br/>
                                                             旅游者确认签名（盖章）：<em class="all-line" style="width:70px;">${travelContractVO.travellers!''}</em>　　
     ...
     <p>
     	附件2：《旅游行程单》<br/>
        <span>行程单另附</span><br/>
                                          旅游者：（代表人签字）<em class="all-line" style="width:120px;">${travelContractVO.travellers!''}　</em>
                                          旅行社：（盖章）<em class="all-line" style="width:120px;"> <img src="../../img/${(travelContractVO.stampImage)!''}" style="no-repeat;width:160px;height:160px;display:block;left:787px;padding-bottom：7px;"/> </em><br/>
     ...
     <p>
        ...
        <table border="0" cellspacing="1" cellpadding="0" class="tab1">
            ...
            <tr>
                ...
                <td>${prodContractDetail.address!''}</td>
                <td>${prodContractDetail.detailName!''}</td>
                <td>${prodContractDetail.detailValue!''}</td>
                <td>${prodContractDetail.stay!''}</td>
                <td>${prodContractDetail.other!''}</td>
                <td>签名：<em class="all-line" style="width:100px;">${travelContractVO.travellers!''}</em></td>
            </tr>
            </#list>
            <#else>
            <tr>
	 ...
	 <p>
        ...
        <table border="0" cellspacing="1" cellpadding="0" class="tab1">
            ...
            <tr>
		        ...
		        <td>${prodContractDetail.stay!''}</td>
		        <td>${prodContractDetail.other!''}</td>
                <td>签名:<em class="all-line" style="width:100px;"></em></td>
            </tr>
            </#list>
            <#else>
            <tr>
     ...
     <table border="0" cellspacing="1" cellpadding="0" class="tab1">
         ...
         <tr>
             <td style="height: 600px;">
                  <textarea name="supplementaryTerms" style="text-align:left;width: 620px; height: 600px;" >
                 
                      ${(travelContractVO.supplementaryTerms)!''}
