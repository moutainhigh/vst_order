<html xmlns="http://www.w3.org/1999/xhtml"> 
 ...
 <div class="txt-hetong">
    ...
    (3)行程中发生的旅游者个人费用，包括但不限于交通工具上的非免费餐饮费、行李超重费，住宿期间的洗衣、电话、饮
        ...
        旅游者（甲方）：<em class="all-line" style="width:200px"><input type="text" style="width:170px;margin-bottom: 0px;" readonly="readonly" name="travellers" value="${(travelContractVO.travellers)!''}"/>　</em>共
             <em class="all-line" style="width:50px"> <input type="text" style="width:30px;margin-bottom: 0px;" name="travellersSize" value="${travelContractVO.travellersSize}"/> 　</em>人（名单可附页，需旅行社和旅游者代表签字盖章确认）；<br/>
        旅行社（乙方）：<em class="all-line" style="width:240px"> <input type="text" style="width:220px;margin-bottom: 0px;" name="filialeName" value="${travelContractVO.filialeName}"/> 　</em>;<br/>
        旅行社业务经营许可证编号：<em class="all-line" style="width:200px">　<input type="text" style="width:220px;margin-bottom: 0px;" name="permit" value="${(travelContractVO.permit)!''}"/>  </em><br/><br/>
        第二十条  线路行程时间<br/>
		出发时间<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" name="visitTime" value="${travelContractVO.visitTime} "/></em>，
                       结束时间<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" name="overDate" value="${travelContractVO.overDate} "/> </em>；
                                  共<em class="all-line" style="width:40px"><input type="text" style="width:30px;margin-bottom: -16px;" name="routeDays" value="${(travelContractVO.routeDays)!''} "/> 　</em>天，
                      饭店住宿<em class="all-line" style="width:130px">　<input type="text" style="width:120px;margin-bottom: 0px;" value="具体以行程单为准"/> </em>夜。<br/>
        第二十一条  旅游费用及支付（以人民币为计算单位）<br/>
        成人<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" name="priceAdult" value="${travelContractVO.priceAdult!'/'}"/>  </em>元/人，
        儿童（不满14岁）<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" name="priceChild" value="${travelContractVO.priceChild!'/'}"/>  </em>元/人；
        其中，导游服务费<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" value="${'/'}"/>  </em>元/人；<br/>
        旅游费用合计：<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" name="traveAmount" value="${(travelContractVO.traveAmount)!'/'}"/>   </em>元。<br/>
        旅游费用支付方式：<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" value="${'在线支付'} "/> </em>。<br/>
        旅游费用支付时间：<em class="all-line" style="width:100px">　<input type="text" style="width:90px;margin-bottom: 0px;" name="paymentTime" value="${travelContractVO.paymentTime!''}"/>   </em>。<br/>
		第二十二条  人身意外伤害保险<br/>
        ...
        <img src="${(travelContractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />
                         ...
                         委托旅行社购买（旅行社不具有保险兼业代理资格的，不得勾选此项）：保险产品名称<em class="all-line" style="width:130px"><input type="text" style="width:120px;margin-bottom:-16px;" name="insuranceCompanyAndProductName" value="${(travelContractVO.insuranceCompanyAndProductName)!'/'} "/> 　</em>投保的相关信息以实际保单为准）；<br/>
        <#if (travelContractVO.hasInsurance)! false >
        <img src="${(travelContractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />
        <#else>
        <img src="${(travelContractVO.templateDirectory)!''}/image/checkedRadioButton.jpg" />
        ...
        成团的最低人数：<em class="all-line" style="width:100px"> <input type="text" style="width:90px;margin-bottom:-16px;" name="minPersonCountOfGroup" value="${(travelContractVO.minPersonCountOfGroup)!''}"/>　</em>人。<br/>
        如不能成团，旅游者是否同意按下列方式解决：<br/>
        1.<em class="all-line" style="width:80px"> 　<input type="text" style="width:70px;margin-bottom: 0px;" value="同意"/></em>（同意或者不同意，打勾无效）旅行社委托<br/>
        <em class="all-line" style="width:80px">　<input type="text" style="width:70px;margin-bottom: 0px;" value="指定"/></em>旅行社履行合同；<br/>
        2.<em class="all-line" style="width:80px">　<input type="text" style="width:70px;margin-bottom: 0px;" value="同意"/></em>（同意或者不同意，打勾无效）延期出团；<br/>
        3.<em class="all-line" style="width:80px">　<input type="text" style="width:70px;margin-bottom: 0px;" value="同意"/></em>（同意或者不同意，打勾无效）改签其他线路出团；<br/>
        4.<em class="all-line" style="width:80px">　<input type="text" style="width:70px;margin-bottom: 0px;" value="同意"/></em>（同意或者不同意，打勾无效）解除合同。<br/>
        第二十四条  
                       组团方式<br/>
        <#if travelContractVO.productDelegate == 'SELF_TOUR'>
            <img src="${(travelContractVO.templateDirectory)!''}/image/checkedRadioButton.jpg" /> 自行组团<br/>
            <img src="${(travelContractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />
                                     委托组团  委托社为<em class="all-line" style="width:130px"> <input type="text" style="width:120px;margin-bottom:-16px;" name="productDelegateName" value="${travelContractVO.productDelegateName!'/'}"/>　</em>，具体的旅游服务和操作由委托社提供。<br/>
        <#elseif travelContractVO.productDelegate == 'COMMISSIONED_TOUR'>
           <img src="${(travelContractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" /> 自行组团<br/>
           <img src="${(travelContractVO.templateDirectory)!''}/image/checkedRadioButton.jpg" />
                                 委托组团  委托社为<em class="all-line" style="width:130px"> <input type="text" style="width:120px;margin-bottom:-16px;" name="productDelegateName" value="${travelContractVO.productDelegateName!'/'}"/>　</em>，具体的旅游服务和操作由委托社提供。<br/>
        </#if>
        <img src="${(travelContractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />          
	...
	第二十六条  争议的解决方式<br/>
                               ...
                               织等有关部门或者机构申请调解。协商或者调解不成的，按下列第<em class="all-line" style="width:100px;text-align:center;"> <input type="text" style="width:90px;margin-bottom: 0px;" value="2"/> </em>种方式解决：<br/>
        <input type="radio" name="style"/>1.提交<em class="all-line" style="width:100px;"></em>仲裁委员会仲裁；<br/>
        <input type="radio" name="style" checked="checked"/>2.依法向人民法院起诉。<br/>
        第二十七条  其他约定事项<br/>
        ...
        第二十八条　合同效力<br/>
        本合同一式<em class="all-line" style="width:50px"><input type="text" style="width:40px;margin-bottom: 0px;" value="贰"/></em>份，
        双方各持<em class="all-line" style="width:50px"><input type="text" style="width:40px;margin-bottom: 0px;" value="壹"/></em>份，具有同等法律效力，自双方当事人签字或者盖章之日起生效。<br/>
     </p><br/><br/><br/><br/><br/>
     <p style=" position:relative;">
     	<span class="stamp"></span>
     	旅游者代表签字（盖章）：<em class="all-line" style="width:130px"> <input type="text" style="width:120px;margin-bottom:-16px;" readonly="readonly" name="fullName" value="${(travelContractVO.travellers)!''}"/>　</em>
     	旅行社盖章：<em class="all-line" style="width:174px">　</em><br/>   
        证件号码：<em class="all-line" style="width:200px"> <input type="text" style="width:180px;margin-bottom: 0px;" name="" value="${'详见旅游报名表'}"></em>
        签约代表签字（盖章）：<em class="all-line" style="width:128px">　</em><br/>
        住　　址：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" name="personAddress" value="${(travelContractVO.personAddress)!'/'}"/> </em>
        营业地址：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${(travelContractVO.address)!'上海市嘉定区景域大道88号驴妈妈科技园'} "/></em><br/>     
        联系电话：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: -18px;vertical-align:bottom;" name="mobile" value="${(travelContractVO.mobile)!'/'}"/>　</em>
        联系电话：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${'1010-6060'}"/> </em><br/>      
        传　　真：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${'/'}"/></em>
        传　　真：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${'/'}"/></em><br/> 
        邮　　编：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${'/'}"/></em>
        邮　　编：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${(travelContractVO.postcode)!'200233'}"/> </em><br/> 
        电子信箱：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" name="email" value="${(travelContractVO.email)!'/'}"/></em>
        电子信箱：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: -18px;vertical-align:bottom" value="${'service@lvmama.com'}"/>　</em><br/> 
        签约日期：<em class="all-line" style="width:200px"> <input type="text" style="width:180px;margin-bottom: 0px;" name="createTime" value="${travelContractVO.createTime!''}"/> </em>
       签约日期：<em class="all-line" style="width:50px">　<input type="text" style="width:180px;margin-bottom: 0px;" name="createTime" value="${travelContractVO.createTime!''}"/></em><br/>
        签约地点：<em class="all-line" style="width:200px">　<input type="text" style="width:180px;margin-bottom: 0px;" value="${'/'}"/></em><br/><br/>
        
        
        
        旅行社监督、投诉电话：<em class="all-line" style="width:200px"> <input type="text" style="width:180px;margin-bottom: 0px;" name="jianduTel" value="${(travelContractVO.jianduTel)!'/'}"/></em><br/>
        <em class="all-line" style="width:80px;"> <input type="text" style="width:70px;margin-bottom:-16px;" name="province" value="${(travelContractVO.province)!'/'}"/>　</em>省
        <em class="all-line" style="width:80px;">　<input type="text" style="width:70px;margin-bottom: 0px;" name="city" value="${(travelContractVO.city)!'/'} "/></em>市旅游质监执法机构：<br/>
        投诉电话：<em class="all-line" style="width:200px;">　<input type="text" style="width:180px;margin-bottom: 0px;" name="lvTSTelephone" value="${(travelContractVO.lvTSTelephone)!'/'}"/></em><br/>   
        电子邮箱：<em class="all-line" style="width:200px;"><input type="text" style="width:180px;margin-bottom: 0px;" value="${'/'}"/>　</em><br/>
        地　　址：<em class="all-line" style="width:200px;"><input type="text" style="width:180px;margin-bottom: 0px;" name="lvAddress" value="${(travelContractVO.lvAddress)!'/'}"/>　</em><br/> 
        邮　　编：<em class="all-line" style="width:200px;">　<input type="text" style="width:180px;margin-bottom: 0px;" name="lvpostcode" value="${(travelContractVO.lvpostcode)!'/'}"/></em><br/><br/><br/><br/>                           
     </p>
     <#include "/order/econtractTemplate/attachmentTemplate.ftl"/>
</div>
 </form>
 <#include "/base/foot.ftl"/>
 
<p align="center">
    <button class="ct_form_tjBtn"  onclick="editButtomOnclick()">保存且发送</button>
