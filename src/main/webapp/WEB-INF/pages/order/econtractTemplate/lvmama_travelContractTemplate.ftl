<html xmlns="http://www.w3.org/1999/xhtml"> 
 ...
 <style type="text/css"> 
	* {margin:0;padding:0;}
	...
	.stamp{background:url(../../img/${(contractVO.stampImage)!''}) no-repeat;width:160px;height:160px;display:block;position:absolute;left:420px;top:0px;}
 ...
 <div class="txt-hetong">
    ...
    <p>
        第一条  合同标的
        <br/>
        旅游产品名称<em class="all-line" style="width:286px">${(contractVO.productName)!''}</em>
        <br />
        组团方式（二选一）
        <br />
        <#if (contractVO.delegateGroup)! false >
        <img src="${(contractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />
        <#else>
        <img src="${(contractVO.templateDirectory)!''}/image/checkedRadioButton.jpg" />
        </#if> 
        自行组团<br/>
        <#if (contractVO.delegateGroup)! false >
        <img src="${(contractVO.templateDirectory)!''}/image/checkedRadioButton.jpg" />
       ...
       委托组团（委托社全称<em class="all-line" style="width:286px">${(contractVO.delegateGroupName)!''}</em>）。
        <br />
        出发日期<em class="all-line" style="width:186px">${(contractVO.vistDate!'')}</em>，出发地点<em class="all-line" style="width:186px">${(contractVO.departurePlace!'')}</em>。
        <br/>
        途经地点（经停地点）<em class="all-line" style="width:286px">详见旅游行程单与本合同具有同等效力 </em>。      
        <br/>
        目的地点<em class="all-line" style="width:286px">${(contractVO.destination!'')}</em>
        <br/>
        结束日期<em class="all-line" style="width:186px">${(contractVO.overDate)!''}</em>，返回地点<em class="all-line" style="width:186px">${(contractVO.returnPlace)!''}</em>。
        <br/>
        ...
        <br/>
        <br/>
        地接社名称<em class="all-line" style="width:215px">${(contractVO.localTravelAgencyName)!''}</em>，
        地址<em class="all-line" style="width:215px">${(contractVO.localTravelAgencyAddress)!''}</em>，
        <br/>
        <br/>
        ...
        第三条  旅游者保险
        <br/>
        乙、丙方提示甲方购买旅游意外险。经乙、丙方推荐，甲方<em class="all-line" style="width:100px">${(contractVO.agreeInsurance)!''}</em>（应填同意或不同意，打勾无效）委托乙方或丙方办理个人投保的旅游意外保险。
        <br/>
        保险公司及产品名称<em class="all-line" style="width:215px">${(contractVO.insuranceCompanyAndProductName)!''}</em>。
        <br/>
        保险金额<em class="all-line" style="width:215px">详见旅游行程单与本合同具有同等效力</em>，
        保险费<em class="all-line" style="width:215px">${(contractVO.insuranceAmount)!''}</em>。
        <br/>
        第四条  旅游费用及其支付
        <br/>
        甲方应交纳旅游费用<em class="all-line" style="width:315px">${(contractVO.traveAmount)!''}</em>元，大写<em class="all-line" style="width:100px">${(contractVO.chineseNumeralTraveAmount)!''}</em>元。
        <br/>
        旅游费用交纳期限<em class="all-line" style="width:215px">下单时付清全部款项</em>。
        <br/>
        旅游费用交纳方式 <img src="${(contractVO.templateDirectory)!''}/image/uncheckedCheckBox.jpg" />现金；<img src="${(contractVO.templateDirectory)!''}/image/uncheckedCheckBox.jpg" />支票；<img src="${(contractVO.templateDirectory)!''}/image/uncheckedCheckBox.jpg" />信用卡；<img src="${(contractVO.templateDirectory)!''}/image/uncheckedCheckBox.jpg" />其他
        <em class="all-line" style="width:270px">
        ${(contractVO.payWay)!''}
        </em>。
    	<br/>
        第五条 双方的权利义务 
        ...
        <#else>
         <img src="${(contractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />
                      ...
                      最低成团人数<em class="all-line" style="width:100px">${(contractVO.minPersonCountOfGroup)!''}</em>人；低于此人数不能成团时，乙方应当提前30日通知甲方，<br />
                      本合同解除，向甲方退还已收取的全部费用。
        <br/>
        <#if (contractVO.hasMinPersonCount)! false >
         <img src="${(contractVO.templateDirectory)!''}/image/uncheckedRadioButton.jpg" />
     ...
     <div style=" position:relative;">
         ...
         <p> 甲方签字（签章）：<em class="all-line" style="width:160px">${(contractVO.signaturePersonName)!''}</em> 乙方签字（盖章）：<em class="all-line" style="width:200px">上海驴妈妈兴旅国际旅行社有限公司</em></p> 
         <p> 住所：<em class="all-line" style="width:232px">/</em> 营业场所：<em class="all-line" style="width:248px">上海市嘉定区景域大道88号驴妈妈科技园</em></p> 
         <p> 甲方代表：<em class="all-line" style="width:208px">${(contractVO.firstDelegatePersonName)!''}</em> 乙方代表（经办人）：<em class="all-line" style="width:188px">/</em></p> 
         <p> 联系电话：<em class="all-line" style="width:208px">${(contractVO.contactTelePhoneNo)!''}</em> 联系电话：<em class="all-line" style="width:248px">1010-6060  </em></p> 
         <p> 邮编：<em class="all-line" style="width:232px">/</em> 邮编：<em class="all-line" style="width:272px">201803 </em></p> 
         <p> 日期：<em class="all-line" style="width:232px">${(contractVO.firstSignatrueDate)!''}</em> 日期：<em class="all-line" style="width:272px">${(contractVO.secondSignatrueDate)!''}</em></p>   
     </div>	
