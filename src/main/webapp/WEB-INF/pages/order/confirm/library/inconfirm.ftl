<div id="result" class="iframe_content mt20">
	<div class="fl operate" style="margin: 10px 0 10px;">
		<a class="btn btn_cc1" id="pending" href="javascript:switchDelay('')">待处理（${pendingNum!0}）</a>
		<a class="btn btn_cc1" id="delay" href="javascript:switchDelay('Y')">暂缓（${delayNum!0}）</a>
		<a class="btn btn_cc1" id="query" href="/vst_order/ord/order/confirm/queryInconfirm.do" target="_blank">已审库查询</a>
	</div>
	<#if resultPage?? >
