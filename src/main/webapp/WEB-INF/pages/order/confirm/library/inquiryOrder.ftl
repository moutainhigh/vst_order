	                        ...
	                        <#list resultPage.items as result>
	                                <tr>
	                                    <td>
                                            ...
                                            <#if result.orderMonitorRst.distributorName=='10'>
                                                <front style="color: red;">O2O先资审</front><br>
                                            <#elseif  result.orderMonitorRst.distributorName=='4'>
                                                <front style="color: red;">分销先资审</front><br>
                                            </#if>
                                        ...
                                        <td width="220">
                                        	<div class="fl operate"">
                                            	<a class="btn btn_cc1" href="javascript:void(0)" onclick="javascript:orderPassInquiryAudit(this,'${result.auditId}');" style="text-decoration:none;cursor:pointer;">审核通过</a>
	                                      		<a class="btn btn_cc1" href="javascript:void(0)" onclick="javascript:showCancelOrder('${result.objectId}')" style="text-decoration:none;cursor:pointer;">审核不通过</a>
	                                      	</div>	
