...
<body>
	...
	<div class="iframe_search">
		<form method="post" action='/vst_order/order/ordManualDistOrder/query.do' id="searchForm">
...
<#--<form method="post" action='/vst_order/order/ordManualDistOrder/manualDistOrder.do' id="dataForm">
...
<script>
	...
	function distOrderUser(){
		...
		showSelectEmployeeDialog = 
				new xDialog("/vst_order/ord/ordManualDistOrder/showSelectEmployee.do",
	...
	$(function(){
		...
		$("#clear_button").bind("click",function(){
			window.location.href = "/vst_order/order/ordManualDistOrder/responsible.do";
		});
