            ...
            <#if number==1>
            	<#if orderRequiredvO.ennameType=="TRAV_NUM_ONE" || orderRequiredvO.ennameType=="TRAV_NUM_ALL">
            	  <tr>
		        	...
		        	<td>
		        		<input class="input js_yz" id="firstName${number_index}" name="travellers[${number_index}].firstName" value="${tavellerList[number_index].firstName}" name_type="firstName" type="text" placeholder="firstName" <#if orderRequiredvO.expandMap['ennameType_OPTIONAL']!='Y'>required="true"</#if>>
		        		<span class="error_text" style="display:none;"><i class="tip-icon tip-icon-error"></i>firstName不正确</span>
		        		<input class="input js_yz" id="lastName${number_index}" name="travellers[${number_index}].lastName"  name_type="lastName" type="text" placeholder="lastName" value="${tavellerList[number_index].lastName}" <#if orderRequiredvO.expandMap['ennameType_OPTIONAL']!='Y'>required="true"</#if>>
		    	...
		    	<#if orderRequiredvO.outboundPhoneType=="TRAV_NUM_ONE" || orderRequiredvO.outboundPhoneType=="TRAV_NUM_ALL">
			    	 <tr>
			        	...
			        	<td>
			        		<input id="outboundPhone${number_index}" name="travellers[${number_index}].outboundPhone" value="${tavellerList[number_index].outboundPhone}" id="outboundPhone${number_index}"
			    ...
			    <#if orderRequiredvO.idNumType=="TRAV_NUM_ONE" || orderRequiredvO.idNumType=="TRAV_NUM_ALL">
			       ...
			       <select class="select" name="travellers[${number_index}].idType" birthday="<#if tavellerList[number_index].birthday??>${tavellerList[number_index].birthday?string("yyyy-MM-dd")}</#if>"  gender="${tavellerList[number_index].gender}"  expDate= "<#if tavellerList[number_index].expDate??>${tavellerList[number_index].expDate?string("yyyy-MM-dd")}</#if>" issued="${tavellerList[number_index].issued}" id="idType${number_index}" num="${number_index}" old="${tavellerList[number_index].idType}">
			        		...
			        		<input type_name="shenfenzheng" id="idNo${number_index}" name="travellers[${number_index}].idNo" value="${tavellerList[number_index].idNo}" type="text" placeholder="证件号码" maxlength="25" name_type="idNo" <#if orderRequiredvO.expandMap['idNumType_OPTIONAL']!='Y'>required="true"</#if>>
