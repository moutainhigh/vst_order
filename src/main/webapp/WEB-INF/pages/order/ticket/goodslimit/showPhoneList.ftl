...
<script>
    ...
    $("#addIDCARD").click(function(){
        ...
        addDialog = new xDialog("/vst_order/goods/goodsLimit/addBlackList.do",{"goodId":goodId,"blacklistType":blacklistType}, {title:"添加手机号",width:500,hight:400,scrolling:"yes"})
    });
