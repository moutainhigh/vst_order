	...
	<div class="iframe_content">
        <div class="hotel_title">
        	<div class="hotel_t">
            	<#if suppGoodsFlag??&&suppGoodsFlag>
	        		...
	        		<a href="http://www.lvmama.com/vst_front/scenic-${suppGoods.prodProduct.productId}" target="_blank">产品名称：${suppGoods.prodProduct.productName}</a>
	        	</#if>
            </div>
		...
		<div class="p_box mt20">
			<div class="hotel_wrap">
	            ...
	            <div class="hotel_tab">
	            	请选择游玩日期：<input type="text" id="visitDate" name="visitTime" style="width:100px;" value="${suppGoodsBaseTimePrice.specDate?string('yyyy-MM-dd')}"
		...
		<div class="p_box mt20">
            ...
            <div id="ticketDiv" class="hotel_tab">
                ...
                <#if suppGoodsFlag??&&suppGoodsFlag>
                	 ...
                	 <input type="hidden" name="masterSuppGoodsId" value="${masterSuppGoodsId}"/>
	        		 <#include "/order/ticket/inc/goods_info.ftl"/>
	        		 <div id="otherTicketDiv">
	        		 <#include "/order/ticket/inc/other_goods_info.ftl"/>
	        		 </div>
	        	</#if>
             </div>
