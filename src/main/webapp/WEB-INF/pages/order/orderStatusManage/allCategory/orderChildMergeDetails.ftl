...
-->
                            ...
                            <li><a id="showLog" href="javaScript:" title="查看日志">查看日志</a></li>
                              ...
                              <@mis.checkPerm permCode="6220"><li><a id="changeAmount" href="javaScript:" title="修改价格">修改价格--</a></li></@mis.checkPerm>
                                <li><a id="changeAmount" href="javaScript:" title="修改结算价">修改结算价--</a></li>
                                <li><a id="viewPassCode"  target="_blank" href="/vst_passport/passCode/findList.do?orderId=${order.orderId}"  title="查看通关码">查看通关码</a></li>
                            
                             <li><a id="viewPassCode"  target="_blank" href="/vst_passport/passCode/findList.do?orderId=${order.orderId}"  title="查看签证审核">查看签证审核--</a></li>
                             <li><a id="viewPassCode"  target="_blank" href="/vst_passport/passCode/findList.do?orderId=${order.orderId}"  title="查看投保状态">查看投保状态--</a></li>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var touristData="orderItemId="+${RequestParameters.orderItemId};
         	...
         	$.post("/vst_order/order/orderManage/findTouristList.do",
			   touristData,
			   function(result){
