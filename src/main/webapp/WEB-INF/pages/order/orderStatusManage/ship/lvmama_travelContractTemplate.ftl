<html xmlns="http://www.w3.org/1999/xhtml"> 
 ...
 <form action="#" method="post" id="dataForm">
    ...
    <input type="hidden" name="stampImage" value="${(contractVO.stampImage)!''}">
 ...
 <div class="txt-hetong">
    ...
    <p>
     ...
     <div style=" position:relative;">
         ...
         <p> 甲方签字（签章）：<em class="all-line" style="width:160px"><input type="text" style="width:168px;height:25px" name="signaturePersonName" id="signaturePersonName" value="${(contractVO.signaturePersonName)!''}">  </em> 乙方签字（盖章）：<em class="all-line" style="width:200px">上海驴妈妈兴旅国际旅行社有限公司</em></p> 
...
$("#editButton").bind("click",function(){
	...
	$.ajax({
	   url : "/vst_order/order/orderShipManage/updateTravelContract.do",
