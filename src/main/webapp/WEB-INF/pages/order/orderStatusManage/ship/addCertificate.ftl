<form action="#"  enctype="multipart/form-data" method="post" target="ajaxUpload"  id="dataForm">
	<input type="hidden" name="orderItemId" id="orderId" value="${RequestParameters.orderItemId}">
...
<script>
	...
	$("#saveButton").bind("click",function(){
			...
			if("FAX"==confirmType || "EBK"==confirmType ){
			...
			var param={orderItemId:orderItemId,operation:operation,fileId:fileId,confirmType:confirmType,attachmentName:attachmentName,orderRemark:orderRemark};
