        ...
        <tbody>
            <tr>
              ...
              <tr>
                ...
                <td>
                	<input type="text" name="fullName" value="${ordPerson.fullName!''}" required>
                </td>
               </tr>
               <tr>
                ...
                <td>
                	<input type="text" name="mobile" value="${ordPerson.mobile!''}" required number=true maxlength="50">
                </td>
            </tr> 
            <tr>
...
$("#editButton").bind("click",function(){
	...
	$.ajax({
	   url : "/vst_order/order/orderShipManage/updatePerson.do",
