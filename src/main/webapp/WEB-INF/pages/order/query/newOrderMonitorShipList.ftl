...
<div class="iframe_search">
	<form id="searchForm" action="/vst_order/ord/order/newOrderMonitorShipList.do" method="post">
        ...
        <table class="s_table2 form-inline">
            <tbody>
                <tr>
                 ...
                 <tr>
                    　<td colspan="2">
                    	<label>产品类型：<@s.formSingleSelect "monitorCnd.categoryIds" productCategoryMap 'style="width:115px;" '/></label>
                        <label>供应商名称：
