...
<div class="iframe_search">
	<form id="searchForm" action="/vst_order/ord/order/esearchorder.do" method="post">
                 ...
                 <tr>
                    　<td colspan="2">
	                        ...
	                        <label>出团通知书状态：<@s.formSingleSelect "monitorCnd.noticeRegimentStatus" noticeRegimentStatusMap 'class="w10"'/></label>
	                         <label>是否后置：<@s.formSingleSelect "monitorCnd.travellerDelayFlag" travellerDelayFlagMap 'class="w10"'/></label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        ...
                        <label>是否锁定：<@s.formSingleSelect "monitorCnd.travellerLockFlag" travellerLockFlagMap 'class="w14"'/></label>
                    </td>
                </tr>
            </tbody>
        </table>        
...
<script type="text/javascript">
	$(function(){
		...
		$("#clear_button").bind("click",function(){
			window.location.href = "/vst_order/ord/order/esinitialsearch.do";
		});
