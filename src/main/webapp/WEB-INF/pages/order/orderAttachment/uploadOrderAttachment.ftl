...
<script type="text/javascript">
	...
	$("#saveButton").bind("click",function(){
			...
			//异步调用后台
			$.ajax({
			   url : "/vst_order/ord/order/addOrderAttachment.do",
			   data : {orderId:orderId,fileId:fileId,fileName:fileName,memo:memo,orderType:"${RequestParameters.orderType!''}",orderItemId:"${RequestParameters.orderItemId}"},
			   type:"POST",
			   dataType:"JSON",
	...
	//取消按钮事件
	$("#closeButton").bind("click", function() {uploadOrderAttachmentDialog.close();});
</script>
