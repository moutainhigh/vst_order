            ...
            <div class="hotel_tab_box">
                    <div class="hotel_tab">
						...
						<#if hiddenMain?? && hiddenMain?size &gt; 0>
							<#if hiddenMain['fangchaDiv']??>
							${hiddenMain['fangchaDiv']}
											...
											<table class="tab_nav" width="100%">
												<tr class="table_nav">
													<td width="50%">
														...
														<input type="hidden" id="fangChaAllPrice" name="fangChaAllPrice" value=""/></td>
														<input type="hidden" id="fangChaPrice" name="fangChaPrice" value="${fanchaTotalPrice}"/></td>
													<td width="20%" class="orange">单价:￥${fanchaTotalPrice}元</td>
													<td width="20%">
		        				...
		        				<#list additionList as pb>		        					
		        					<#assign goods=pb.suppGoodsList[0] />
			        					...
			        					<tr class="table_nav" adult="" child=""  suppGoodsId="${goods.suppGoodsId}">
			        						...
			        						<td width="20%" class="orange" id="unitGapPriceId">单价:￥${goods.suppGoodsBaseTimePrice.auditPriceYuan}元</td>
			        						<td width="20%">
			        							<#if goods.parentGoodsRelation??&&goods.parentGoodsRelation.relationType='AMOUNT'>
			        								<input auditPrice="${goods.suppGoodsBaseTimePrice.auditPriceYuan}" childPrice="${goods.suppGoodsBaseTimePrice.childPriceYuan}" type="text" goodsId="${goods.suppGoodsId}" class="w5 numText hotel_sum" readOnly name="itemMap[${goods.suppGoodsId}].adultQuantity" style="text-align:center;width:45px" value="${goods.fitChildQuantity+goods.fitAdultQuantity}" required=true number=true />
			        							<#else>
			        								<@line_func.showOptionSelect 0 pb goods "goods"/>
			        							</#if>	        							
			        						</td>
