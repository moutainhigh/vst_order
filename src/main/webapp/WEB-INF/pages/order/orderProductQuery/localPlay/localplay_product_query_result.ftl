                    ...
                    <tbody>
                        ...
                        <td>
                            <table class="co_table">
                                <thead> 
                                    <tr class="noborder">
                                        <th nowrap="nowrap" style="width:25%">产品Id</th>
                                        <th nowrap="nowrap" style="width:25%">商品名称</th>
                                        <th nowrap="nowrap" style="width:25%">支付对象</th>
                                		...
                                		<tr>
                                			...
                                			<td>
	                                         ...
	                                         <td>
	                                        	...
	                                        	name="goodsId" value="预订" onclick="toBook('/vst_order/ord/book/localPlay/infoFillIn.do?goodsId=${suppGoods.suppGoodsId}');">
	                                        </td>
                                		</tr>
                                	</#list>
                                	</#if>
...
<#else>
	<div class="no_data mt20"><i class="icon-warn32"></i>暂无相关当地玩乐产品，请重新输入相关条件查询！</div>
</#if>
