<html xmlns="http://www.w3.org/1999/xhtml"> 
 ...
 <div class="txt-hetong">
    ...
    <br/>
    <p>
        <b>委托方（以下简称甲方）：</b><em class="all-line" style="width:220px"> ${(travelContractVO.travellers)!''}</em>
   ...
   <p style="position: relative;">
       ...
       <b>甲方 ： （签字或盖章）<em class="all-line" style="width:85px;">${(travelContractVO.travellers)!''}</em></b>
 ...
 <span style="float:right">
		<em class="all-line" style="width:100px;">　${travelContractVO.createTime!''} </em><b></b>
    </span>
