 ...
 <style type="text/css"> 
	* {margin:0;padding:0;}
	...
	@media screen and (max-width: 640px) {
        body{padding: 0 10px;min-width: 320px;box-sizing:border-box;
            -moz-box-sizing:border-box; /* Firefox */
            -webkit-box-sizing:border-box; /* Safari */}
        .txt-hetong {margin:0;width: 100%}
        .contractImg{display: none}
        .stamp{display: none; }
    }
 </style> 
 </head> 
...
<div class="txt-hetong">
    ...
    <table border="0"  class="tab1">
    	<tr>
        	<td rowspan="3" width="8%">旅游者姓名</br>共（ ${order.ordTravellerList?size}）人</td>
            <td rowspan="3" colspan="2" width="24%">${travelContractVO.travellers!''}</td>
            <td width="12%">团号</td>
            <td width="24%" colspan="2">/</td>
            <td width="12%">出发时间</td>
            <td width="12%">	<#if order.visitTime ??>${order.visitTime?string('yyyy-MM-dd') !''}</#if></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" width="36%">
                ...
                成人 <em class="all-line" style="width:20px;text-align:center;">  ${(travelContractVO.aduitCount)!''}</em>人   <em class="all-line" style="width:20px;text-align:center;">${(travelContractVO.priceAdult)!''}</em>元/人<br/>
        ...
        <tr>
            ...
            <td colspan="7">
               <#if travelContractVO.productDelegate == 'COMMISSIONED_TOUR'>
		           本产品由上海驴妈妈兴旅国际旅行社有限公司代理招徕，委托社为<em class="all-line" style="width:270px;">${(travelContractVO.productDelegateName)!''} </em>，具体旅游服务和操作由委托社提供。 <br/>                         
		     </#if>
        ...
        <tr>
            ...
            <em class="contractImg" style=" position:absolute;right:120px;top:-30px;">
            <img src="http://pic.lvmama.com/img/order/stamp/${(travelContractVO.stampImage)!''}" width="120" height="120"/></em>
            </#if>
            </span></td>
        </tr>
        <tr>
            ...
            <td>北京分社地址：</td>
            <td colspan="3">北京市朝阳区左家庄曙光西里甲6号院时间国际大厦</br>1号楼907-08室</td>
        </tr>
        <tr>
        	<td>住所:</td>
            <td colspan="3"></td>
        ...
        <tr>
        	<td>签约时间:</td>
            <td> <#if order.createTime ??>${order.createTime?string('yyyy-MM-dd') !''}</#if></td>
            <td>电话：</td>
