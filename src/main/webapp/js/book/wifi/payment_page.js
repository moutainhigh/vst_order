...
$('.js_dikou_quxiao').live('click',function(){
	...
	function addCard(cardName,cardNo,card){
		...
		var cardHtml ='<tr><td>'+cardNo+'</td><td>'+cardPrice/100+'元</td>'
					...
					+'<td><div class="yong_price" yong_price="0"><input class="input"  id="'+inputAmtId+'" type="text">元</div></td>'
					+'<td><span  '+cardinfostr
					+'  class="btn btn-mini btn-orange js_card_ok  '+confclazz+'" id="'+confBtnId+'">确认</span>'
					+' <span class="btn btn-mini btn-default js_card_cancel  '+canclazz+'" id="'+cancBtnId+'">取消</span></td></tr>';
		if(cardName=='储值卡'){
