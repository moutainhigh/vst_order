...
/**
 * MyBatis的Oracle Dao基类
 * @author chenlizhao
 *
 */
@Repository
public class MyBatisOraDao extends SqlSessionTemplateOraDaoSupport {

	private static final Log LOG = LogFactory.getLog(MyBatisOraDao.class);

	private int maxRows = 1001;
	private int maxRowsForReport = 50000;
	private String namespaceName;

	public MyBatisOraDao() {
		
	}

	public MyBatisOraDao(String namespaceName) {
		super();
	 ...
	 * @return 记录数
	 */
	protected Long queryCount(final String statementName, final Object parameterObject) {
		return getSqlSession().selectOne(createStatementName(statementName), parameterObject);
	}
