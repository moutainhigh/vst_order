...
public class OutboundTourContractDataVO implements Serializable{

	private static final long serialVersionUID = 7209461836316445590L;
	
	//补充条款
	private String supplementaryTerms;
	
	//购物说明
	private List<ProdContractDetail> shopingDetailList;
	
	//推荐项目
	private List<ProdContractDetail> recommendDetailList;
