...
@Controller
public class OrderByPayPaymentAction extends BaseActionSupport {

	private static final Logger LOG = LoggerFactory.getLogger(OrderByPayPaymentAction.class);
	 ...
	 * 支付页面地址
	 */
	private final String BY_POSTDATE_PAY = "/order/byPostdatePay/by_postdate_pay";
	
	@RequestMapping(value="/order/byPostdatePay/byPay",method=RequestMethod.GET)
