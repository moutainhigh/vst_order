...
import com.lvmama.vst.order.client.service.ebk.OrdEbkConnectsPassService;
import com.lvmama.vst.order.dao.EbkConnectsPassDao;
 ...
 *
 */
@Service("ordEbkConnectsPassService")
public class OrdEbkConnectsPassServiceImpl implements OrdEbkConnectsPassService {

	private Log log = LogFactory.getLog(OrdEbkConnectsPassServiceImpl.class);
	
	@Autowired
	private EbkConnectsPassDao ebkPassDao;
