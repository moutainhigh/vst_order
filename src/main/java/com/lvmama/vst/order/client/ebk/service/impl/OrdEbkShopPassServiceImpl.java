...
import com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService;
import com.lvmama.vst.order.dao.EbkShopPassDao;
 ...
 *
 */
@Service("ordEbkShopPassService")
public class OrdEbkShopPassServiceImpl implements OrdEbkShopPassService {

	private Log log = LogFactory.getLog(OrdEbkShopPassServiceImpl.class);

	@Autowired
	private EbkShopPassDao ebkPassDao;

	
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPassStatisListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPassStatisCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPassListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPassListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPassListForReportByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkMiddleListByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkMiddleListCount(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkMiddleListForReportByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPostListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPostListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShopPassService#selectEbkPostListForReportByPrams(java.util.Map)
	 */
	@Override
