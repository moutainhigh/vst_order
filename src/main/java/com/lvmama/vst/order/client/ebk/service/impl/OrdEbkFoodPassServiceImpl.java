...
import com.lvmama.vst.order.client.service.ebk.OrdEbkFoodPassService;
import com.lvmama.vst.order.dao.EbkFoodPassDao;
 ...
 *
 */
@Service("ordEbkFoodPassService")
public class OrdEbkFoodPassServiceImpl implements OrdEbkFoodPassService {

	private Log log = LogFactory.getLog(OrdEbkFoodPassServiceImpl.class);

	@Autowired
	private EbkFoodPassDao ebkPassDao;
	...
	public int transferOrder(Map<String, Object> params) {
		return this.ebkPassDao.transferOrder(params);
	}
