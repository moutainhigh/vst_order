...
import com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService;
import com.lvmama.vst.order.dao.EbkWifiPassDao;
 ...
 *
 */
@Service("ordEbkWifiPassService")
public class OrdEbkWifiPassServiceImpl implements OrdEbkWifiPassService {

	private Log log = LogFactory.getLog(OrdEbkWifiPassServiceImpl.class);

	@Autowired
	private EbkWifiPassDao ebkPassDao;

	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPassStatisListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPassStatisCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPassListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPassListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPassListForReportByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkMiddleListByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkMiddleListCount(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkMiddleListForReportByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPostListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPostListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkWifiPassService#selectEbkPostListForReportByPrams(java.util.Map)
	 */
	@Override
