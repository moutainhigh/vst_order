...
import com.lvmama.vst.order.client.service.ebk.OrdEbkPassService;
import com.lvmama.vst.order.dao.EbkPassDao;
 ...
 *
 */
@Service("ordEbkPassService")
public class OrdEbkPassServiceImpl implements OrdEbkPassService {
	
	private Log log = LogFactory.getLog(OrdEbkPassServiceImpl.class);

	@Autowired
	private EbkPassDao ebkPassDao;

	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPassStatisListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPassStatisCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPassListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPassListCount(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPassListForReportByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkMiddleListByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkMiddleListCount(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkMiddleListForReportByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPostListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPostListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkPassService#selectEbkPostListForReportByPrams(java.util.Map)
	 */
	@Override
	...
	@Override
	public HashMap<String, Object> selectRemainCount(Long orderItemId) {
		return ebkPassDao.selectRemainCount(orderItemId);
	}
