...
import com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService;
import com.lvmama.vst.order.dao.EbkShowTicketPassDao;
 ...
 *
 */
@Service("ordEbkShowTicketPassService")
public class OrdEbkShowTicketPassServiceImpl implements OrdEbkShowTicketPassService {

	private Log log = LogFactory.getLog(OrdEbkShowTicketPassServiceImpl.class);

	@Autowired
	private EbkShowTicketPassDao ebkPassDao;
	
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPassStatisListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPassStatisCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPassListByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	@ForceRead
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPassListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPassListForReportByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	@ForceRead
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkMiddleListByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkMiddleListCount(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkMiddleListForReportByPrams(java.util.Map)
	 */
	@Override
	@ReadOnlyDataSource
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPostListByPrams(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPostListCount(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lvmama.vst.order.client.service.ebk.OrdEbkShowTicketPassService#selectEbkPostListForReportByPrams(java.util.Map)
	 */
	@Override
