 ...
 * 按价格类型(含房差)分摊的子单的分摊信息补全服务
 */
@Service("apportionComplete4PriceTypeSpreadServiceImpl")
public class ApportionParticle4PriceTypeSpreadServiceImpl extends ApportionParticleByPriceTypeAbsService implements ApportionParticleByPriceTypeService {
    ...
    protected String[] getAllValidPriceType() {
        return new String[] {OrderEnum.ORDER_PRICE_RATE_TYPE.PRICE_ADULT.name(),
                OrderEnum.ORDER_PRICE_RATE_TYPE.PRICE_CHILD.name(),
                OrderEnum.ORDER_PRICE_RATE_TYPE.PRICE_SPREAD.name()};
    }
