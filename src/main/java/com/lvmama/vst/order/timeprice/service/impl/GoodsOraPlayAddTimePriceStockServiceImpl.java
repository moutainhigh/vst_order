...
import com.lvmama.vst.order.dao.goods.*;
 ...
 *
 */
@Component("goodsOraPlayAddTimePriceStockService")
public class GoodsOraPlayAddTimePriceStockServiceImpl implements IGoodsTimePriceStockService{
    private static final Logger logger = LoggerFactory.getLogger(GoodsOraPlayAddTimePriceStockServiceImpl.class);
