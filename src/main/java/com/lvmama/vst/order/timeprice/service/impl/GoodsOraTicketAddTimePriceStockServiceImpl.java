 ...
 *
 */
@Component("goodsOraTicketAddTimePriceStockService")
public class GoodsOraTicketAddTimePriceStockServiceImpl implements IGoodsTimePriceStockService{
...
//			SuppGoodsAddTimePrice timePrice = suppGoodsAddTimePriceDao.selectByPrimaryKey(timePriceId);
...
//			timePrice = suppGoodsAddTimePriceDao.getTimePriceAtCreateOrder(goodsId, specDate);
...
//			timePrice = suppGoodsAddTimePriceDao.getTimePrice(goodsId, specDate);
	...
	private static final Logger logger = LoggerFactory.getLogger(GoodsOraTicketAddTimePriceStockServiceImpl.class);
